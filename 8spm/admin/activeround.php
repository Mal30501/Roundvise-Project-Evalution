...
<div class="content-wrapper">
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Activating Round</li>
        </ol>
        <div class="box_general padding_bottom">
            <div class="header_box version_2">
                <h2><i class="fa fa-user"></i>Activate Round</h2>
            </div>
            <form method="post" enctype="multipart/form-data" action="activatinground.php">
                <div class="row">
                    <div class="col-md-6">
